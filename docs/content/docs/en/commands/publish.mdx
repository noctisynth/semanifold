...
Release creation and asset upload failures retain the package and failure stage, partial publish report, and recovery guidance. An existing Release still follows the normal idempotent skip behavior.
