...
Changelog pull request metadata lookup failures remain warnings. They now include the affected package and GitHub diagnostic; version preparation continues without that remote metadata.
