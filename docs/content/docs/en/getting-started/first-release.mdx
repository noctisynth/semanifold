...
<Availability status="released">
  This tutorial uses <strong>Semifold 0.3.0-rc.5</strong> and only features available in that published version.
</Availability>
...
- its reason points to the `add-api` changeset;
...
## 4. Preview and apply version changes
