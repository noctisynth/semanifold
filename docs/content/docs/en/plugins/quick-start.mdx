...
<Availability status="next">
  Run this guide after a Semifold release containing `semifold 0.3.0-rc.6` and `@semifold/plugin-sdk 0.1.0-rc.0` is published. The APIs are implemented on `main`; `0.3.0-rc.5` cannot load these plugins.
</Availability>
...
```bash
pnpm add --save-dev @semifold/plugin-sdk@0.1.0-rc.0
```
