...
`publish = false` marks a crate as unavailable for registry publishing. A private crate still participates in version calculation, shared-version groups, file edits, and dependency ordering.
